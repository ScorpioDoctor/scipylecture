...
例子: fake dimensions with strides
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
Array 的兄弟姐妹: :class:`chararray`, :class:`maskedarray`, :class:`matrix`
==========================================================================

:class:`chararray`: 矢量化字符串操作
--------------------------------------------------
